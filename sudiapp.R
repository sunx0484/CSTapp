...
# Objects -  Prep city and township data 1900 - 2000 --------------------------------------------------------
...
#Objects - for merging 2010 and 2016 data on Id2short --------------------------------------

subtotal_2010_2016 <- full_join(pop.countysub.2016, pop.countysub.2010, by = c("Id2short","placeName"), copy = FALSE, suffix = c(".16", ".10"))

#Objects - for merging subtotal_2010_2016 (2010+2016) and 1900_200 on Id2short---------------------
...
pop.city <- pop.countysub.1900_2016 %>%
  filter(area == "City") %>%
  mutate(
    pop = ifelse(year == "2010" & Id == "0600000US2704915704798", 175, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2704915704798", 228, pop),
    
    pop = ifelse(year == "2010" & Id == "0600000US2700312306382", 57186, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2700312306382", 61210, pop),

    pop = ifelse(year == "2010" & Id == "0600000US2703914706580", 1996, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2703914706580", 1814, pop),

    pop = ifelse(year == "2010" & Id == "0600000US2705906507282", 1793, pop),

    pop = ifelse(year == "2016" & Id == "0600000US2705906507282",1860, pop),

    
    pop = ifelse(year == "2010" & Id == "0600000US2712114508092", 743, pop),

    pop = ifelse(year == "2016" & Id == "0600000US2712114508092",630, pop),
    
    pop = ifelse(year == "2010" & Id == "0600000US2701905310918", 22952, pop),

    pop = ifelse(year == "2016" & Id == "0600000US2701905310918",24796, pop),

    
    pop = ifelse(year == "2010" & Id == "0600000US2704510911008", 2779, pop),

    pop = ifelse(year == "2016" & Id == "0600000US2704510911008",2821, pop),

    
    pop = ifelse(year == "2010" & Id == "0600000US2714517111800", 1735, pop),

    pop = ifelse(year == "2016" & Id == "0600000US2714517111800",1743, pop),

    
    pop = ifelse(year == "2010" & Id == "0600000US2703315112772", 382, pop),

    pop = ifelse(year == "2016" & Id == "0600000US2703315112772",383, pop),

    
    pop = ifelse(year == "2010" & Id == "0600000US2705317115022", 4671, pop),

    pop = ifelse(year == "2016" & Id == "0600000US2705317115022",5031, pop),

    
    pop = ifelse(year == "2010" & Id == "0600000US2704913115706", 212, pop),
  #  pop = ifelse(year == "2010" & Id == "0600000US2704915706", NA, pop),
   # pop = ifelse(year == "2010" & Id == "0600000US2713115706", NA, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2704913115706",162, pop),

    
    pop = ifelse(year == "2010" & Id == "0600000US2709314518134", 1042, pop),

    pop = ifelse(year == "2016" & Id == "0600000US2709314518134",981, pop),

    
    pop = ifelse(year == "2010" & Id == "0600000US2707916119160", 652, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2707916119160",655, pop),

    
    pop = ifelse(year == "2010" & Id == "0600000US2705317126990", 2938, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2705317126990",3064, pop),

    pop = ifelse(year == "2010" & Id == "0600000US2702317325280", 2897, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2702317325280",2557, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2703716327530", 22172, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2703716327530",22501, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2711713331760", 633, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2711713331760",601, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2705516933866", 4830, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2705516933866",4808, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2704915734172", 5063, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2704915734172",5111, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2707910314336746", 4058, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2707910314336746",3996, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2701307910339878", 39309, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2701307910339878",40900, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2715716943198", 111, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2715716943198",110, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2701304343198", 687, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2701304343198",616, pop),
     
    pop = ifelse(year == "2010" & Id == "0600000US2702109744422", 671, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2702109744422",635, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2702109744422", 7321, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2702109744422",7534, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2703713146924", 20007, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2703713146924",20405, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2701310347068", 13394, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2701310347068",13451, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2709116548562", 131, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2709116548562",100, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2704115348796", 1740, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2704115348796",1665, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2704910951136", 3263, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2704910951136",3314, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2709514152522", 4698, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2709514152522",4785, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2712712953656", 5254, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2712712953656",5086, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2705317155006", 4316, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2705317155006",4229, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2707713555438", 151, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2707713555438",142, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2711116756014", 493, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2711116756014",497, pop),
    
    pop = ifelse(year == "2010" & Id == "0600000US2700909756176", 1242, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2700909756176",1262, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2700305956950", 7218, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2700305956950",7377, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2715315962446", 2981, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2715315962446",2968, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2709715363778", 350, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2709715363778",321, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2711115967504", 4088, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2711115967504",4079, pop),
  
    pop = ifelse(year == "2010" & Id == "0600000US2712316369970", 23797, pop),
    pop = ifelse(year == "2016" & Id == "0600000US2712316369970",24992, pop)
  )

pop.city1 <-subset(pop.city,Id != "0600000US2704904798" & Id != "0600000US2715704798" & Id != "0600000US2700306382" & Id != "0600000US2712306382" & Id != "0600000US2703906580" & Id != "0600000US2714706580"
                   & Id != "0600000US2705907282" & Id != "0600000US2706507282" & Id != "0600000US2712108092" & Id != "0600000US2714508092" & Id != "0600000US2701910918" & Id != "0600000US2705310918" 
                   & Id != "0600000US2704511008" & Id != "0600000US2710911008" & Id != "0600000US2714511800" & Id != "0600000US2717111800" & Id != "0600000US2701512772" & Id != "0600000US2703312772"
                   & Id != "0600000US2705315022" & Id != "0600000US2717115022" & Id != "0600000US2704915706" & Id != "0600000US2713115706" & Id != "0600000US2709318134" & Id != "0600000US2714518134"
                   & Id != "0600000US2707919160" & Id != "0600000US2716119160" & Id != "0600000US2702325280" & Id != "0600000US2717325280" & Id != "0600000US2704934172" & Id != "0600000US2715734172"
                   & Id != "0600000US2705326990" & Id != "0600000US2717126990" & Id != "0600000US2703727530" & Id != "0600000US2716327530" & Id != "0600000US2707936746" & Id != "0600000US2710336746" & Id != "0600000US2714336746" 
                   & Id != "0600000US2711731760" & Id != "0600000US2713331760" & Id != "0600000US2705533866" & Id != "0600000US2716933866" & Id != "0600000US2701339878" & Id != "0600000US2707939878" & Id != "0600000US2710339878"
                   & Id != "0600000US2715743036" & Id != "0600000US2716943036" & Id != "0600000US2701343198" & Id != "0600000US2704343198" & Id != "0600000US2702144422" & Id != "0600000US2709744422"
                   & Id != "0600000US2707945808" & Id != "0600000US2713945808" & Id != "0600000US2703746924" & Id != "0600000US2713146924" & Id != "0600000US2701347068" & Id != "0600000US2710347068"
                   & Id != "0600000US2709148562" & Id != "0600000US2716548562" & Id != "0600000US2704148796" & Id != "0600000US2715348796" & Id != "0600000US2704951136" & Id != "0600000US2710951136"
                   & Id != "0600000US2709552522" & Id != "0600000US2714152522" & Id != "0600000US2712753656" & Id != "0600000US2712953656" & Id != "0600000US2705355006" & Id != "0600000US2717155006"
                   & Id != "0600000US2707755438" & Id != "0600000US2713555438" & Id != "0600000US2711156014" & Id != "0600000US2716756014" & Id != "0600000US2700956176" & Id != "0600000US2709756176"
                   & Id != "0600000US2700356950" & Id != "0600000US2705956950" & Id != "0600000US2715362446" & Id != "0600000US2715962446" & Id != "0600000US2709763778" & Id != "0600000US2715363778"
                   & Id != "0600000US2711167504" & Id != "0600000US2715967504" & Id != "0600000US2712369970" & Id != "0600000US2716369970")


pop.township <- pop.countysub.1900_2016 %>%
...
township.list <- pop.township %>%
  select(2)%>%
  distinct(placeName) %>%
  arrange(placeName)

vis.list <- c("Data points", "Trend lines", "Both visualizations") %>% 
  as.list()
...
ui <- fluidPage(
   ...
   # Application title
   titlePanel("CITY AND TOWNSHIP GRAPH"),
   ...
   tabPanel("Population trends",
            mainPanel(
              tabsetPanel(
                tabPanel("City",
                         selectInput(inputId = "population.charts.city.list",
                                     label = "Choose a city",
                                     choices = city.list,
                                     multiple = TRUE),
                         radioButtons(inputId="population.charts.city.vis.list",
                                      label = "How would you like to visualize the data?",
                                      choices=vis.list,
                                      inline = TRUE),
                         ggiraphOutput("citypopulation")),
                tabPanel("Township",
                         selectInput(inputId = "population.charts.township.list",
                                     label = "Choose a township",
                                     choices = township.list,
                                     multiple = TRUE),
                         radioButtons(inputId="population.charts.township.vis.list",
                                      label = "How would you like to visualize the data?",
                                      choices=vis.list,
                                      inline = TRUE),
                         ggiraphOutput("townshippopulation")))))
)


server <- function(input, output) {
  output$citypopulation <-  renderggiraph({
    population.city.plot <- ggplot(filter(pop.city1, placeName %in% input$population.charts.city.list), aes(x=year,y=as.integer(pop), color=placeName,fill=placeName)) +
      labs(x="Year", y="Population")

    
    if (input$population.charts.city.vis.list == "Data points") {
      population.city.plot <-  population.city.plot +geom_point_interactive(size=3, aes(tooltip = paste(year,comma(pop, digits = 0),sep = ": population of "), data_id=pop))
      
    } else if (input$population.charts.city.vis.list =="Trend lines") {
      population.city.plot <-  population.city.plot + geom_line(aes(colour=placeName, group=placeName))
    } else if (input$population.charts.city.vis.list == "Both visualizations") {
      
      population.city.plot <-  population.city.plot +geom_point_interactive(size=3, aes(tooltip = paste(year,comma(pop, digits = 0),sep = ": population of "), data_id=pop))+ geom_line(aes(colour=placeName, group=placeName))
    } 
    
    ggiraph(code=print(population.city.plot), selection_type="none", width_svg=10,hover_css = "r:7;")
    
  })
   
  output$townshippopulation <-  renderggiraph({
    population.township.plot <- ggplot(filter(pop.township, placeName %in% input$population.charts.township.list), aes(x=year,y=as.integer(pop), color=placeName,fill=placeName)) +
      labs(x="Year", y="Population")
    
    if (input$population.charts.township.vis.list == "Data points") {
      population.township.plot <-  population.township.plot +geom_point_interactive(size=3, aes(tooltip = paste(year,comma(pop, digits = 0),sep = ": population of "), data_id=pop))
      
    } else if (input$population.charts.township.vis.list =="Trend lines") {
      population.township.plot <-  population.township.plot + geom_line(aes(colour=placeName, group=placeName))
    } else if (input$population.charts.township.vis.list == "Both visualizations") {
      
      population.township.plot <-  population.township.plot +geom_point_interactive(size=3, aes(tooltip = paste(year,comma(pop, digits = 0),sep = ": population of "), data_id=pop))+ geom_line(aes(colour=placeName, group=placeName))
    } 
    ggiraph(code=print(population.township.plot), selection_type="none", width_svg=10,hover_css = "r:7;")
